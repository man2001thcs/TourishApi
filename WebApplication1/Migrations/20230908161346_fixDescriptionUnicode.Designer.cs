...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20230908161346_fixDescriptionUnicode")]
    partial class fixDescriptionUnicode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApplication1.Data.SaveFile", b =>
                {
                    b.HasOne("WebApplication1.Data.Message", "Message")
                        .WithMany("Files")
                        .HasForeignKey("AccessSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_SaveFile_Message");
